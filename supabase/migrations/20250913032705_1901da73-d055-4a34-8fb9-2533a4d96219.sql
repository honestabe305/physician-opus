...
CREATE TRIGGER update_physician_licenses_updated_at
BEFORE UPDATE ON public.physician_licenses
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER update_physician_certifications_updated_at
BEFORE UPDATE ON public.physician_certifications
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER update_physician_education_updated_at
BEFORE UPDATE ON public.physician_education
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER update_physician_work_history_updated_at
BEFORE UPDATE ON public.physician_work_history
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER update_physician_hospital_affiliations_updated_at
BEFORE UPDATE ON public.physician_hospital_affiliations
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER update_physician_compliance_updated_at
BEFORE UPDATE ON public.physician_compliance
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();

CREATE TRIGGER update_physician_documents_updated_at
BEFORE UPDATE ON public.physician_documents
FOR EACH ROW
EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE INDEX idx_physicians_created_at ON public.physicians(created_at);
CREATE INDEX idx_physician_licenses_physician_id ON public.physician_licenses(physician_id);
CREATE INDEX idx_physician_licenses_state ON public.physician_licenses(state);
CREATE INDEX idx_physician_certifications_physician_id ON public.physician_certifications(physician_id);
CREATE INDEX idx_physician_education_physician_id ON public.physician_education(physician_id);
CREATE INDEX idx_physician_work_history_physician_id ON public.physician_work_history(physician_id);
CREATE INDEX idx_physician_hospital_affiliations_physician_id ON public.physician_hospital_affiliations(physician_id);
CREATE INDEX idx_physician_compliance_physician_id ON public.physician_compliance(physician_id);
CREATE INDEX idx_physician_documents_physician_id ON public.physician_documents(physician_id);
CREATE INDEX idx_physician_documents_type ON public.physician_documents(document_type);