-- Create enum types for better data consistency (if they don't exist)
DO $$ BEGIN
...
DROP POLICY IF EXISTS "Staff and admins can create physicians" ON public.physicians;
DROP POLICY IF EXISTS "Staff and admins can update physicians" ON public.physicians;
DROP POLICY IF EXISTS "Only admins can delete physicians" ON public.physicians;
