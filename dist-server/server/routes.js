...
const storage = new storage_1.PostgreSQLStorage();
...
router.post('/profiles', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertProfileSchema.parse(req.body);
...
router.get('/profiles/user/:userId', asyncHandler(async (req, res) => {
...
router.put('/profiles/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertProfileSchema.partial().parse(req.body);
...
// Physician routes
router.post('/physicians', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianSchema.parse(req.body);
...
router.get('/physicians', asyncHandler(async (req, res) => {
    ...
    let physicians;
    if (search) {
        physicians = await storage.searchPhysicians(search);
    }
    else if (status) {
        physicians = await storage.getPhysiciansByStatus(status);
    }
    else {
    ...
    if (limit || offset) {
        ...
        const endIndex = startIndex + (parseInt(limit) || physicians.length);
...
router.get('/physicians/:id', asyncHandler(async (req, res) => {
...
router.get('/physicians/:id/full', asyncHandler(async (req, res) => {
...
router.get('/physicians/npi/:npi', asyncHandler(async (req, res) => {
...
router.put('/physicians/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianSchema.partial().parse(req.body);
    const physician = await storage.updatePhysician(req.params.id, validatedData);
    res.json(physician);
}));
router.delete('/physicians/:id', asyncHandler(async (req, res) => {
    await storage.deletePhysician(req.params.id);
    res.status(204).send();
}));
// Physician License routes
router.post('/physicians/:physicianId/licenses', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianLicenseSchema.parse({
        ...req.body,
...
router.get('/physicians/:physicianId/licenses', asyncHandler(async (req, res) => {
...
router.get('/licenses/expiring/:days', asyncHandler(async (req, res) => {
...
router.put('/licenses/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianLicenseSchema.partial().parse(req.body);
...
router.post('/physicians/:physicianId/certifications', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianCertificationSchema.parse({
        ...req.body,
        physicianId: req.params.physicianId
    });
...
router.get('/physicians/:physicianId/certifications', asyncHandler(async (req, res) => {
...
router.get('/certifications/expiring/:days', asyncHandler(async (req, res) => {
    const days = parseInt(req.params.days);
    if (isNaN(days) || days < 0) {
        return res.status(400).json({ error: 'Days must be a non-negative number' });
    }
...
router.put('/certifications/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianCertificationSchema.partial().parse(req.body);
...
router.post('/physicians/:physicianId/education', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianEducationSchema.parse({
        ...req.body,
        physicianId: req.params.physicianId
    });
...
router.get('/physicians/:physicianId/education', asyncHandler(async (req, res) => {
    const education = await storage.getPhysicianEducations(req.params.physicianId);
    res.json(education);
}));
router.get('/education/:id', asyncHandler(async (req, res) => {
...
router.put('/education/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianEducationSchema.partial().parse(req.body);
...
router.post('/physicians/:physicianId/work-history', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianWorkHistorySchema.parse({
        ...req.body,
        physicianId: req.params.physicianId
    });
...
router.get('/physicians/:physicianId/work-history', asyncHandler(async (req, res) => {
    const workHistory = await storage.getPhysicianWorkHistories(req.params.physicianId);
    res.json(workHistory);
}));
router.get('/work-history/:id', asyncHandler(async (req, res) => {
...
router.put('/work-history/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianWorkHistorySchema.partial().parse(req.body);
    const workHistory = await storage.updatePhysicianWorkHistory(req.params.id, validatedData);
    res.json(workHistory);
}));
router.delete('/work-history/:id', asyncHandler(async (req, res) => {
    await storage.deletePhysicianWorkHistory(req.params.id);
    res.status(204).send();
}));
// Physician Hospital Affiliation routes
router.post('/physicians/:physicianId/hospital-affiliations', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianHospitalAffiliationSchema.parse({
        ...req.body,
        physicianId: req.params.physicianId
    });
...
router.get('/physicians/:physicianId/hospital-affiliations', asyncHandler(async (req, res) => {
    const affiliations = await storage.getPhysicianHospitalAffiliations(req.params.physicianId);
    res.json(affiliations);
}));
router.get('/hospital-affiliations/:id', asyncHandler(async (req, res) => {
...
router.put('/hospital-affiliations/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianHospitalAffiliationSchema.partial().parse(req.body);
    const affiliation = await storage.updatePhysicianHospitalAffiliation(req.params.id, validatedData);
    res.json(affiliation);
}));
router.delete('/hospital-affiliations/:id', asyncHandler(async (req, res) => {
    await storage.deletePhysicianHospitalAffiliation(req.params.id);
    res.status(204).send();
}));
// Physician Compliance routes
router.post('/physicians/:physicianId/compliance', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianComplianceSchema.parse({
        ...req.body,
        physicianId: req.params.physicianId
    });
...
router.get('/physicians/:physicianId/compliance', asyncHandler(async (req, res) => {
...
router.get('/compliance/:id', asyncHandler(async (req, res) => {
...
router.put('/compliance/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianComplianceSchema.partial().parse(req.body);
...
router.post('/physicians/:physicianId/documents', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianDocumentSchema.parse({
        ...req.body,
        physicianId: req.params.physicianId
    });
...
router.get('/physicians/:physicianId/documents', asyncHandler(async (req, res) => {
    const { type } = req.query;
    let documents;
    if (type) {
        documents = await storage.getPhysicianDocumentsByType(req.params.physicianId, type);
    }
    else {
...
router.put('/documents/:id', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianDocumentSchema.partial().parse(req.body);
...
router.get('/analytics/physicians/status-summary', asyncHandler(async (req, res) => {
...
router.get('/analytics/licenses/expiration-report', asyncHandler(async (req, res) => {
...
router.get('/analytics/certifications/expiration-report', asyncHandler(async (req, res) => {
    const { days = 30 } = req.query;
    const daysNum = parseInt(days);
    if (isNaN(daysNum) || daysNum < 0) {
        return res.status(400).json({ error: 'Days must be a non-negative number' });
...
// Bulk operations
router.post('/physicians/bulk', asyncHandler(async (req, res) => {
    ...
    for (let i = 0; i < physicians.length; i++) {
        try {
            const validatedData = schema_1.insertPhysicianSchema.parse(physicians[i]);
            const physician = await storage.createPhysician(validatedData);
...
router.post('/documents/upload-url/:physicianId', asyncHandler(async (req, res) => {
...
router.post('/documents', asyncHandler(async (req, res) => {
    const validatedData = schema_1.insertPhysicianDocumentSchema.parse(req.body);
    const document = await storage.createPhysicianDocument(validatedData);
    res.status(201).json(document);
}));
router.get('/physicians/:physicianId/documents', asyncHandler(async (req, res) => {
